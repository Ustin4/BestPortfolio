	...
	const projects = [
		{
			...
			description:
				'This application provides a means for efficient learning through the use of flashcards.',
			imgUrl: projImg3,
		...
		},
		{
			title: 'Todolist',
			description:
				'TodoList app is a simple and convenient tool for task management. It helps you organize your tasks, create a task list, and track their completion.',
			imgUrl: projImg4,
